...
export default class extends Abstract {
	...
	async getHtml() {
		return `
      <h1 class='block text-2xl font-bold text-slate-800 dark:text-white'>Dashboard</h1>
			<p class="mt-4">
      ...
      <div class="mt-5 flex gap-2">
        <a href="/posts" data-link class="inline-flex items-center gap-2 rounded-md border border-transparent font-semibold text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 text-sm">
          Go to Posts
        </a>
      </div>
    `;
